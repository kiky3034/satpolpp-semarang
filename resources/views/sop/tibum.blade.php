...
@section('title', 'Bidang Tibum')

@section('content')

<style>
    /* === HALAMAN Bidang Tibum === */
    .hero-second-banner {
        position: relative;
        display: flex;
        align-items: center;
...
{{-- Hero Banner --}}
    ...
    <div class="content-container">
        <div class="breadcrumb">
            <a href="/home">Beranda</a> > <a href="/home">SOP</a> > <a href="/tibum">Bidang TIBUM</a>
        </div>
        ...
        <div class="mission-box">
            ...
            <div class="content-box">
                <iframe 
                    src="https://drive.google.com/file/d/1rXh3RG54VFu6N6-xKSF_ksDstd7ERYeP/preview" 
                    width="100%" 
                    height="600px" 
