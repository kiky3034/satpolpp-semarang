...
@section('title', 'Gelar Perkara')

@section('content')

<style>
    /* === HALAMAN Gelar Perkara === */
    .hero-second-banner {
        position: relative;
        display: flex;
        align-items: center;
...
{{-- Hero Banner --}}
    ...
    <div class="content-container">
        <div class="breadcrumb">
            <a href="/home">Beranda</a> > <a href="/home">SOP</a> > <a href="/bidang_ppud">Bidang PPUD</a> > <span>Gelar Perkara</span>
        </div>
        ...
        <div class="mission-box">
            ...
            <div class="content-box">
                <iframe 
                    src="https://drive.google.com/file/d/1umhMSZK1Bbv6rum0E55zYFHUuHYRWr8-/preview" 
                    width="100%" 
                    height="600px" 
