...
@section('title', 'Bidang Binmas')

@section('content')

<style>
    /* === HALAMAN Bidang Binmas === */
    .hero-second-banner {
        position: relative;
        display: flex;
        align-items: center;
...
{{-- Hero Banner --}}
    ...
    <div class="content-container">
        <div class="breadcrumb">
            <a href="/home">Beranda</a> > <a href="/home">SOP</a> > <a href="/binmas">Bidang BINMAS</a>
        </div>
        ...
        <div class="mission-box">
            ...
            <div class="content-box">
                <iframe 
                    src="https://drive.google.com/file/d/1BIKXvqq8AwYBCpiF0tnGyvbsitKJmpA0/preview" 
                    width="100%" 
                    height="600px" 
