...
@section('title', 'Bidang Linmas')

@section('content')

<style>
    /* === HALAMAN Bidang Linmas === */
    .hero-second-banner {
        position: relative;
        display: flex;
        align-items: center;
...
{{-- Hero Banner --}}
    ...
    <div class="content-container">
        <div class="breadcrumb">
            <a href="/home">Beranda</a> > <a href="/home">SOP</a> > <a href="/linmas">Bidang LINMAS</a>
        </div>
        ...
        <div class="mission-box">
            ...
            <div class="content-box">
                <iframe 
                    src="https://drive.google.com/file/d/1i4vtkTyHw9uh6ro-KF8hU4ISrKL3VjFM/preview" 
                    width="100%" 
                    height="600px" 
