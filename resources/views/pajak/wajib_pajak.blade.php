...
{{-- Hero Banner --}}
    ...
    <div class="content-container">
        <div class="breadcrumb">
            <a href="/home">Beranda</a> > <a href="/home">Pajak Daerah</a> > <span>Daftar Wajib Pajak</span>
        </div>
        ...
        <div class="mission-box">
            ...
            <div class="content-box">
                <iframe 
                    src="https://jatuhtempo.satpolpp.semarangkota.go.id/data" 
                    width="100%" 
                    height="600px" 
