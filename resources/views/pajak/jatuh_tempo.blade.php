...
@section('title', 'Jatuh Tempo Pajak')

@section('content')

<style>
    /* === HALAMAN Jatuh Tempo Pajak === */
    .hero-second-banner {
        position: relative;
        display: flex;
        align-items: center;
...
{{-- Hero Banner --}}
    ...
    <div class="content-container">
        <div class="breadcrumb">
            <a href="/home">Beranda</a> > <a href="/home">Pajak</a> > <span>Jatuh Tempo Pajak</span>
        </div>

        <div class="mission-box">
            <div class="icon-header">
                <h2>JATUH TEMPO PAJAK</h2>
            </div>
            <div class="content-box">
                <iframe 
                    src="https://jatuhtempo.satpolpp.semarangkota.go.id/" 
                    width="100%" 
                    height="600px" 
