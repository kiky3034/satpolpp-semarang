...
@section('title', 'Bidang Kamtibmas')

@section('content')

<style>
        /* === HALAMAN Bidang Kamtibmas === */
        .hero-second-banner {
            position: relative;
            display: flex;
            align-items: center;
...
{{-- Hero Banner --}}
    ...
    <div class="content-container">
        <div class="breadcrumb">
            <a href="/home">Beranda</a> > <a href="/home">Pemberdayaan</a> > <span>Bidang Kamtibmas</span>
        </div>
@endsection