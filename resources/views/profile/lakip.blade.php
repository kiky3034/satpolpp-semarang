...
@section('title', 'Lakip - Satpol PP Semarang')
...
@section('content')
    ...
    <div class="hero-second-banner">
        <div class="overlay-text">
            <h1>Laporan Kinerja Instansi Pemerintah (LAKIP)</h1>
    ...
    <div class="content-container">
        ...
        <div class="profile-content">
            <h2 class="section-title">Laporan Kinerja Instansi Pemerintah (LAKIP)</h2>
            ...
            Laporan kinerja merupakan bentuk akuntabilitas dari pelaksanaan tugas dan fungsi yang dipercayakan kepada setiap instansi pemerintah atas penggunaan anggaran.
             Hal terpenting yang diperlukan dalam penyusunan laporan kinerja adalah pengukuran kinerja dan evaluasi serta pengungkapan (disclosure).
            </p>
            ...
            <div class="pdf-documents-container">
                ...
                <div class="pdf-card">
                    ...
                    <div class="pdf-actions">
                        <a href="/download/renstra-murni.pdf" class="pdf-btn">
                            <i class="fas fa-download"></i> Download
                        </a>
                        <a href="/view/renstra-murni.pdf" target="_blank" class="pdf-btn view-btn">
