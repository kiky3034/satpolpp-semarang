...
@section('title', 'Perda Reklame')

@section('content')

<style>
    /* === HALAMAN Perda Reklame === */
    .hero-second-banner {
        position: relative;
        display: flex;
        align-items: center;
...
{{-- Hero Banner --}}
    ...
    <div class="content-container">
        <div class="breadcrumb">
            <a href="/home">Beranda</a> > <a href="/home">Perda kota Semarang</a> > <span>Perda Reklame</span>
        </div>
        ...
        <div class="mission-box">
            ...
            <div class="content-box">
                <iframe 
                    src="https://drive.google.com/file/d/1hR7xjUytD9J2GpLEDCVrVmv0O1o20gHQ/preview" 
                    width="100%" 
                    height="600px" 
